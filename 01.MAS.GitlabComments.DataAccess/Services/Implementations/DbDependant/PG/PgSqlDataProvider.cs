namespace MAS.GitlabComments.DataAccess.Services.Implementations.DbDependant.PG
{
    ...
    /// <para>For PostgreSQL Database</para>
    /// </summary>
    /// <typeparam name="TEntity">Type of entity</typeparam>
    public class PgSqlDataProvider<TEntity> : SqlDataProviderBase<TEntity>
        where TEntity : BaseEntity
    {
        ...
        /// <summary>
        /// Initializing <see cref="PgSqlDataProvider{TEntity}"/>
        /// </summary>
        ...
        {
            return $"DELETE FROM \"{tableName}\" WHERE \"Id\" = ANY({parameterName})";
        }
