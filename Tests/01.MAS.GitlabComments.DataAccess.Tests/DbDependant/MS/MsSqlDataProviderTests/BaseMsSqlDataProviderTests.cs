namespace MAS.GitlabComments.DataAccess.Tests.SqlDataProviderTests
{
    ...
    /// <summary>
    /// Fake entity for <see cref="MsSqlDataProvider{TEntity}"/> tests
    /// </summary>
    ...
    /// <summary>
    /// Base class for <see cref="MsSqlDataProvider{TEntity}"/> tests
    /// </summary>
    public abstract class BaseMsSqlDataProviderTests
    {
        /// <summary>
        /// Instance of <see cref="MsSqlDataProvider{TEntity}"/> for tests
        /// </summary>
        protected MsSqlDataProvider<TestedDataProviderEntity> TestedService { get; }
        ...
        /// <summary>
        /// Initializing <see cref="BaseMsSqlDataProviderTests"/> with setup'n all required environment
        /// </summary>
        protected BaseMsSqlDataProviderTests()
        {
            var (df, da, fb, ccqb) = GetServiceDependencies();
            TestedService = new MsSqlDataProvider<TestedDataProviderEntity>(df, da, fb, ccqb);
        }
