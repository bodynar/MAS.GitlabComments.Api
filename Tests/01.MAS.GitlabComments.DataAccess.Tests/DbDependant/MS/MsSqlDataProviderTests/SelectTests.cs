namespace MAS.GitlabComments.DataAccess.Tests.SqlDataProviderTests
{
    ...
    /// <summary>
    /// Test suit for method <see cref="MsSqlDataProvider{TEntity}.Select{TProjection}(Select.SelectConfiguration)"/>
    /// </summary>
    public sealed class SelectTests : BaseMsSqlDataProviderTests
    {
