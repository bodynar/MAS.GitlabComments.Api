namespace MAS.GitlabComments.DataAccess.Tests.SqlDataProviderTests
{
    ...
    /// <summary>
    /// Test suit for method <see cref="MsSqlDataProvider{TEntity}.Update(Guid, IDictionary{string, object})"/>
    /// </summary>
    public sealed class UpdateTests : BaseMsSqlDataProviderTests
    {
        [Fact]
