namespace MAS.GitlabComments.DataAccess.Tests.SqlDataProviderTests
{
    ...
    /// </summary>
    public sealed class AddTests : BaseMsSqlDataProviderTests
    {
        [Fact]
        ...
        public void ShouldThrowQueryExecutionExceptionWithBeforeState_WhenEntityClassIsEmpty()
        {
            ...
            var testedService = new MsSqlDataProvider<TestedEmptyDataProviderEntity>(df, da, fb, ccqb); // manually activate because of entity type
