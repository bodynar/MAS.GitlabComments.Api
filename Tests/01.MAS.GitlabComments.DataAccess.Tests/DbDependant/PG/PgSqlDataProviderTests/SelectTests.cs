namespace MAS.GitlabComments.DataAccess.Tests.PgSqlDataProviderTests
{
    ...
    /// <summary>
    /// Test suit for method <see cref="PgSqlDataProvider{TEntity}.Select{TProjection}(SelectConfiguration)"/>
    /// </summary>
    public sealed class SelectTests : BasePgSqlDataProviderTests
    {
        ...
        public void ShouldBuildQueryWithSpecificColumns_WhenProjectedModelHasRequiredAttributes()
        {
            var expectedSql = $"SELECT \"{TestedTableName}\".\"Column1\", \"RightTableName1\".\"Column2\" FROM \"{TestedTableName}\"" +
                $" INNER JOIN \"RightTableName1\" AS \"Alias1\"" +
